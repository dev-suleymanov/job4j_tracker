...
public class AnalyzeByMapTest {
    @Test
    public void whenScorePupil() {
        List<Subject> subjects = new ArrayList<>();
        subjects.add(new Subject("Math", 50));
        subjects.add(new Subject("Lang", 25));
        subjects.add(new Subject("Philosophy", 25));
        Pupil pupil = new Pupil("Ivanov", subjects);
        assertThat(AnalyzeByMap.scoreByIndividualPupil(pupil)).isCloseTo(100.0, offset(0.01D));
    }
